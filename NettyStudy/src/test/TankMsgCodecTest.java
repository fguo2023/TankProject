import com.msb.nettystudy.netty.s08.TankMsg;
import com.msb.nettystudy.netty.s08.TankMsgDecoder;
import com.msb.nettystudy.netty.s08.TankMsgEncoder;
...
public class TankMsgCodecTest {
    ...
    public void testTankMsgEncoder2() {
        ...
        buf.writeInt(msg.x);
        buf.writeInt(msg.y);
        EmbeddedChannel ch = new EmbeddedChannel(new TankMsgEncoder(), new TankMsgDecoder()); // goes from right to left use decoder
